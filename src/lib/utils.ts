...
const FRIENDLY_ERRORS: [RegExp, string][] = [
  ...
  [/new password should be different|same as the old password/i, "Nové heslo musí být jiné než to dosavadní."],
  [/password should be at least|password is too short/i, "Heslo musí mít aspoň 8 znaků."],
  [/password.*(weak|pwned|compromised|easy to guess)|known to be weak/i, "Toto heslo je příliš slabé nebo se objevilo v uniklých datech. Zvolte jiné."],
  [/email not confirmed/i, "E-mail ještě není potvrzený. Klikněte na odkaz v potvrzovacím e-mailu."],
  [/auth session missing|user not found/i, "Přihlášení vypršelo nebo odkaz už neplatí. Požádejte o nový."],
  [/signup.*(disabled|not allowed)|signups not allowed/i, "Registrace jsou vypnuté. Kontaktujte správce."],
